...
| 10,000+ TPS target                        | ✅ ~12,000 ops/s (v0.1.68 baseline; ~7,190 ops/s v0.1.48 historical) (single-node, synchronous, Phase 5 benchmark) |
