...
## [0.1.100](https://github.com/Willow7737/omnia-protocol/compare/v0.1.99...v0.1.100) (2026-08-18)
...
* **api:** report the Lane 0 validator set size, not just the staking registry ([e53768b](https://github.com/Willow7737/omnia-protocol/commit/e53768b9cd77fa71ed6ba690dc83bcd440b01da7))
* **api:** report the Lane 0 validator set size, not just the staking registry ([ed65dfe](https://github.com/Willow7737/omnia-protocol/commit/ed65dfef1552f261b237a6fe54a3c2a5e01bf398))
* **asset-registry:** add treasury allocation with hard limits and asset-scoped balances ([66c5d76](https://github.com/Willow7737/omnia-protocol/commit/66c5d769e18ceda456d8bf873ddc23d16e688ec4))
* **asset-registry:** Spec §4 asset-scoped registry with supply tracking ([9747c5d](https://github.com/Willow7737/omnia-protocol/commit/9747c5d0cd67d19af7045b3a47fb235ac9bc989d))
...
* **codespace:** fix devcontainer setup with proper build script + docs ([741532c](https://github.com/Willow7737/omnia-protocol/commit/741532c447d22d997493fbab763452e7de07e4e1))
...
* execute Omnia Checkpoint Audit priorities — denomination, auth, persistence, quotes, sandbox provider ([da2c45c](https://github.com/Willow7737/omnia-protocol/commit/da2c45c537bb818afa6f9713bf0c11910a2ed497))
* **financial:** complete financial layer - fee/burn, provider, reconciliation, governance, genesis, merchant, property tests ([36c42e5](https://github.com/Willow7737/omnia-protocol/commit/36c42e5e471e88676c7fc9cbb6ed0b80aa27f782))
...
* integrate financial pallets into node runtime (Sprint 3-5) ([12454d5](https://github.com/Willow7737/omnia-protocol/commit/12454d5fd10cb4c8698e3b9ec544bd43407ccaf1))
...
* **payment-order:** 25-state payment order state machine per Spec §8.2, §8.3, §15 ([1a18e3e](https://github.com/Willow7737/omnia-protocol/commit/1a18e3e9dd309c8374726f14bc3bd9daf882dbf1))
...
* Sprint 3-5 — fee-burn, supply tracker, bridge operators ([8d27d81](https://github.com/Willow7737/omnia-protocol/commit/8d27d814f1357795dfffbf9db7061e7eb0b15824))
...
* **treasury:** Sprint 2 — per-bucket spent tracker, §6.3 accounting, inventory reservations, refund path ([22648cc](https://github.com/Willow7737/omnia-protocol/commit/22648ccf11a044f071211264d34c44d1b2977490))
...
* **bench:** correct finality_latency baseline + document P0-1 redundancy ([6b372a4](https://github.com/Willow7737/omnia-protocol/commit/6b372a4b1deb476f0e85c95c48b02c3a715bdb08))
* **bench:** re-baseline ALL benchmarks with P0-1 signature verification cost ([dfe1b02](https://github.com/Willow7737/omnia-protocol/commit/dfe1b02123851bfda4a1c958b2dc237c8d5ebc42))
...
* **bench:** set baselines from SLOW end of runner variance + widen thresholds ([9a7479e](https://github.com/Willow7737/omnia-protocol/commit/9a7479ed4cea53ac245d02a966da9996c45e6c83))
...
* bind payment-order actions to authenticated callers ([b1816ea](https://github.com/Willow7737/omnia-protocol/commit/b1816ea2569804a2029932f8afec308c195370e7))
...
* **build:** vendor Swagger UI assets instead of downloading them at build time ([0ed91af](https://github.com/Willow7737/omnia-protocol/commit/0ed91af636019933cfc9479935fc43f78147e62f))
* **build:** vendor Swagger UI assets instead of downloading them at build time ([babb34f](https://github.com/Willow7737/omnia-protocol/commit/babb34fe99e10efff22a11ca7ea4aa8a13d5045a))
...
* **ci:** auto-sync version files instead of hard-fail in release workflow ([9dd9858](https://github.com/Willow7737/omnia-protocol/commit/9dd9858362b4a457063e5944bc4ff74df855f22f))
* **ci:** bridge.rs doc codeblock + treasury_adapter test per-order limit ([a7ffaed](https://github.com/Willow7737/omnia-protocol/commit/a7ffaed1bf57981be57012db974875b726afe6f7))
...
* **ci:** cargo fmt + fix broken use omnia_shards: imports in test files ([f8eb635](https://github.com/Willow7737/omnia-protocol/commit/f8eb635766ca9274e9c6d68c0a35eec39f43ef4a))
* **ci:** cross-platform disk cleanup — Windows doesn't have /dev/null ([fad8fb1](https://github.com/Willow7737/omnia-protocol/commit/fad8fb1a8272ef32b3908404261b6b9772c2dee2))
* **ci:** delete release-please release before creating (update permission denied) ([e091a3b](https://github.com/Willow7737/omnia-protocol/commit/e091a3b7dbef1c5d8b7f2a745948efba5a5d8470))
* **ci:** download OpenSSL to file before extracting (pipe fails on large files) ([dc89a9b](https://github.com/Willow7737/omnia-protocol/commit/dc89a9b16835f7e592856e4f8516734ee51ed394))
...
* **ci:** resolve all clippy, fmt, and test compilation errors ([df87db2](https://github.com/Willow7737/omnia-protocol/commit/df87db272a4ff11939b3da8b6c4b0d8ef8390e2f))
...
* **ci:** stop release-please.yml failing when no release PR is opened ([d8de0ef](https://github.com/Willow7737/omnia-protocol/commit/d8de0ef4c2fe6191216893736ce6869993032ec9))
* **ci:** stop release-please.yml failing when no release PR is opened ([e4d4233](https://github.com/Willow7737/omnia-protocol/commit/e4d4233f40251a82463a32ca0b38c9cbb9340250))
* **ci:** test code clippy compliance + regenerate Cargo.lock ([3e34710](https://github.com/Willow7737/omnia-protocol/commit/3e34710b6ada3a4ee55427a24d533be772b6c408))
...
* **ci:** use perl instead of sed -i for macOS compat, fix OpenSSL URL ([eb75e97](https://github.com/Willow7737/omnia-protocol/commit/eb75e97f89c47d02b80fedbd59643ddb172a783d))
...
* **ci:** use RELEASE_PAT secret for gh-release, remove non-matching sbom glob ([42286b8](https://github.com/Willow7737/omnia-protocol/commit/42286b8886e91c97a3a40ab4638707edf6c286c2))
...
* **deps:** h2 0.4.16 for RUSTSEC-2026-0258, drop a stale ignore ([2f2096b](https://github.com/Willow7737/omnia-protocol/commit/2f2096bae2c42c7d5ff585e451810fa28cfc762c))
* **deps:** h2 0.4.16 for RUSTSEC-2026-0258, drop a stale ignore ([a996303](https://github.com/Willow7737/omnia-protocol/commit/a9963035030efa7a2a9a492457544382ca2faf9c))
* **deps:** h2 0.4.16 for RUSTSEC-2026-0258, drop a stale ignore ([971f041](https://github.com/Willow7737/omnia-protocol/commit/971f041f932215462879cb7a896f105fa09694a6))
...
* **docker:** copy the financial-layer crate manifests into the builder ([caceb69](https://github.com/Willow7737/omnia-protocol/commit/caceb69bd329f64d8b87ff5b18149b0136aaa84b))
* **docker:** copy the financial-layer crate manifests into the builder ([81bf0bd](https://github.com/Willow7737/omnia-protocol/commit/81bf0bd563c327b79856cf97fc9fdfa05986f1df))
...
* **monitoring:** dashboard queries, alert rules, add deploy script ([74ddbec](https://github.com/Willow7737/omnia-protocol/commit/74ddbec50ff8abd1fc884586750c2f02b901ee28))
* **monitoring:** dashboard queries, alert rules, add deploy script ([682a9e3](https://github.com/Willow7737/omnia-protocol/commit/682a9e3d5deb517119281333ad82ac1c529c5ad0))
...
* release reserved inventory on cancel or refund ([d0b0fa9](https://github.com/Willow7737/omnia-protocol/commit/d0b0fa9a4f204be392eef3b6cae060ecccb05703))
* **release:** align Cargo.toml/Lock to v0.1.95, fix release-please TOML parsing ([85d64f0](https://github.com/Willow7737/omnia-protocol/commit/85d64f082fc2fc40acf60b9b2499ed07d1c7c25c))
* **release:** give release-please the jsonpath it needs, sync Cargo.lock ([54c21c1](https://github.com/Willow7737/omnia-protocol/commit/54c21c1c62b7ed8502b4959c98d2a8929c14a920))
* **release:** give release-please the jsonpath it needs, sync Cargo.lock ([087277a](https://github.com/Willow7737/omnia-protocol/commit/087277a240e5c63c7bac9c82cd1acabb2db718c8))
...
* synchronize dev workspace version and lockfile ([46cac95](https://github.com/Willow7737/omnia-protocol/commit/46cac9544f4b8bca1ed0820380eea18d32b05eb2))
...
* **tests:** add admin key to test server for P0-9 production feature ([3e3024d](https://github.com/Willow7737/omnia-protocol/commit/3e3024d5501b7f5dd545b6b8a8bc3cf0b3de8c18))
* **tests:** add admin key to test server for P0-9 production feature ([adc284d](https://github.com/Willow7737/omnia-protocol/commit/adc284dd6ef23a4c2c711fc8a251d04a3f35aaa3))
...
* treasury_adapter compilation — add missing PaymentError/AssetId imports ([27e8324](https://github.com/Willow7737/omnia-protocol/commit/27e8324c28587fe8b5d270215cc1ad388f73b3f8))
...
* correct the mint-authority runbook against the code ([1042f7e](https://github.com/Willow7737/omnia-protocol/commit/1042f7e25c7f6ac4dd1025f7a4aecda7c5fa292f))
...
* fail closed at every step of the mint-authority procedure ([3516787](https://github.com/Willow7737/omnia-protocol/commit/3516787ae0377d0cad06f85d4b2a9578b6f99b58))
...
* foundation sprint — financial spec, asset registry, payment state machine, treasury policy, RACI, Ghana compliance, release baseline ([9818982](https://github.com/Willow7737/omnia-protocol/commit/9818982902c5d512095994a3bd00e17c64dc8fd5))
* foundation sprint — financial spec, asset registry, payment state machine, treasury policy, RACI, Ghana compliance, release baseline ([216ae19](https://github.com/Willow7737/omnia-protocol/commit/216ae194a77c47b41ba6f7d1f97d10bc94ab31b6))
* how to actually set the mint authority ([86d21e1](https://github.com/Willow7737/omnia-protocol/commit/86d21e1c2feeda5c51fb13abf27a8a15235011e8))
* **operations:** how to actually set the mint authority ([85655b2](https://github.com/Willow7737/omnia-protocol/commit/85655b2f7827ddbdc39616fbb3cb9c3abe44edf2))
...
* state the 201 response from the event submission ([b7b1b12](https://github.com/Willow7737/omnia-protocol/commit/b7b1b121879c4607f10e4845bd555618de5e7d3d))
...
* diagnose platform lockfile resolution ([abdfc42](https://github.com/Willow7737/omnia-protocol/commit/abdfc428ab37d26ab8341990522616a5ba50cced))
* invoke pinned cargo toolchain explicitly ([9905cea](https://github.com/Willow7737/omnia-protocol/commit/9905cea749cddc4ac542af235dc29cde16739345))
* print workspace versions during lock diagnosis ([ba7aeee](https://github.com/Willow7737/omnia-protocol/commit/ba7aeee408a536217ac934d59528b6469fa5f0fb))
...
## [0.1.99](https://github.com/Willow7737/omnia-protocol/compare/v0.1.98...v0.1.99) (2026-08-17)
...
## [0.1.98](https://github.com/Willow7737/omnia-protocol/compare/v0.1.97...v0.1.98) (2026-08-17)
...
## [0.1.97](https://github.com/Willow7737/omnia-protocol/compare/v0.1.96...v0.1.97) (2026-08-17)
...
## [0.1.96](https://github.com/Willow7737/omnia-protocol/compare/v0.1.95...v0.1.96) (2026-08-17)
...
## [0.1.95](https://github.com/Willow7737/omnia-protocol/compare/v0.1.94...v0.1.95) (2026-08-13)
...
## [0.1.94](https://github.com/Willow7737/omnia-protocol/compare/v0.1.93...v0.1.94) (2026-08-12)
