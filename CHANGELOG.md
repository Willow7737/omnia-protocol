...
* restructure documentation into organized hierarchy ([7850778](https://github.com/Willow7737/omnia-protocol/commit/7850778f5e98f86d3d37c2be8135893a785d7618))
* restructure documentation into organized hierarchy ([f6be244](https://github.com/Willow7737/omnia-protocol/commit/f6be2449e659b81c4dc799f6973b1d932613514a))
...
* rectify workflows post-restructuring (Step 6) ([857ada3](https://github.com/Willow7737/omnia-protocol/commit/857ada355497d14f4d6ce3d8665778d58e3cd150))
* rectify workflows post-restructuring (Step 6) ([f3273b7](https://github.com/Willow7737/omnia-protocol/commit/f3273b7f4d4112b650010c72e073b1f8a426ad62))
...
* escape square brackets in rustdoc comments to fix CI doc build ([0a3036e](https://github.com/Willow7737/omnia-protocol/commit/0a3036ecf007da9fdcc4a470cfb872a35fd35053))
...
* **ci:** resolve all failing CI workflow jobs ([7092a68](https://github.com/Willow7737/omnia-protocol/commit/7092a68372875ae61b5e90dfafb841bc50c2351d))

## [0.1.27](https://github.com/Willow7737/omnia-protocol/compare/v0.1.26...v0.1.27) (2026-05-19)


### Bug Fixes

* **ci:** resolve all failing CI workflow jobs ([1e0eab7](https://github.com/Willow7737/omnia-protocol/commit/1e0eab7fdeb73fe0ac037c3155717b6ba2950f18))

## [0.1.26](https://github.com/Willow7737/omnia-protocol/compare/v0.1.25...v0.1.26) (2026-05-19)


### Features

* Phase 4 — Mainnet readiness, settlement integration & architectural closure ([97c2e3c](https://github.com/Willow7737/omnia-protocol/commit/97c2e3cd7b70f53dcc873aab3834b2f1df3e260b))
...
* Phase 3 — Critical security closure, network production readiness, and cryptographic completion ([f8285ab](https://github.com/Willow7737/omnia-protocol/commit/f8285ab6641fe385f17a81b3ffa205212b4fe2eb))
...
* **ci:** resolve all failing GitHub Actions workflows ([74e8ba5](https://github.com/Willow7737/omnia-protocol/commit/74e8ba502e3b4bce91cf25c048b0739bfb006a19))
...
* resolve compilation errors, clippy warnings, and test failures ([87d52bd](https://github.com/Willow7737/omnia-protocol/commit/87d52bdee0721d9cd858f8e4a7e3ccfbbfa8ad0d))
...
* **ci:** resolve all failing GitHub Actions workflows ([7203862](https://github.com/Willow7737/omnia-protocol/commit/72038620e2f3bf70daadf78be0b30e26ae9193db))
...
* **ci:** ignore transitive vulnerability advisories in cargo-deny and cargo-audit ([56841f2](https://github.com/Willow7737/omnia-protocol/commit/56841f27d2bfe24a23bdadae445b03d7c6bac80b))

## [0.1.13](https://github.com/Willow7737/omnia-protocol/compare/v0.1.12...v0.1.13) (2026-05-17)


### Bug Fixes

* **ci:** fix cargo-deny license and wildcard errors ([4720794](https://github.com/Willow7737/omnia-protocol/commit/472079453dab9acd8555166cf512a57db691bf58))
...
* **ci:** resolve all failing GitHub Actions workflows ([5c6d570](https://github.com/Willow7737/omnia-protocol/commit/5c6d570cccd00deb86eb2a158ef94539944234f1))

## [0.1.9](https://github.com/Willow7737/omnia-protocol/compare/v0.1.8...v0.1.9) (2026-05-17)


### Bug Fixes

* make Prettier check non-blocking, exclude generated files ([ebb3c0f](https://github.com/Willow7737/omnia-protocol/commit/ebb3c0f7458c857932d02211cfc992323c26dd2c))

## [0.1.8](https://github.com/Willow7737/omnia-protocol/compare/v0.1.7...v0.1.8) (2026-05-17)


### Bug Fixes

* remaining rustfmt formatting and deny.toml config ([b75c4fa](https://github.com/Willow7737/omnia-protocol/commit/b75c4fac0bf4caf946493333db9045b9cda710bd))
...
* unwrap→expect replacements and utoipa schema derivations ([cbacbfe](https://github.com/Willow7737/omnia-protocol/commit/cbacbfe9b8b3f531a8492199ee77cae46d7dc9a7))
...
* resolve remaining CI failures — compilation and audit ([1eb2193](https://github.com/Willow7737/omnia-protocol/commit/1eb2193f11ef584e4a54a399a604c8da0f1e0a9a))
