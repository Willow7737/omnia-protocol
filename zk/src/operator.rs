...
//! causal graph, builds batches, generates Groth16 proofs, and posts them
//! to the configured settlement layer. The operator is completely
//! L1-agnostic — it works with any [`SettlementLayer`] implementor.
