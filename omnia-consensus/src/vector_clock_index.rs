...
impl VectorClockIndex {
    ...
    pub fn index_event(&mut self, creator: &NodeId, sequence: u64, slot: usize, event_id: EventId) {
...
mod tests {
    ...
    fn test_index_and_resolve() {
        ...
        index.index_event(&creator, 0, 5, event_id);
    ...
    fn test_multiple_sequences() {
        ...
        for seq in 0..5u64 {
            let mut eid = [0u8; 32];
            eid[0] = seq as u8;
            index.index_event(&creator, seq, seq as usize * 10, eid);
        }
    ...
    fn test_multiple_creators() {
        ...
        index.index_event(&creator_a, 0, 0, test_event_id(1));
        index.index_event(&creator_b, 0, 1, test_event_id(2));
        index.index_event(&creator_a, 1, 2, test_event_id(3));
    ...
    fn test_remove_by_slot() {
        ...
        index.index_event(&creator, 0, 5, test_event_id(42));
    ...
    fn test_remove_by_creator_sequence() {
        ...
        index.index_event(&creator, 0, 5, test_event_id(42));
        index.index_event(&creator, 1, 6, test_event_id(43));
    ...
    fn test_max_sequence() {
        ...
        index.index_event(&creator, 0, 0, test_event_id(1));
        assert_eq!(index.max_sequence(&creator), Some(0));

        index.index_event(&creator, 3, 1, test_event_id(2));
        assert_eq!(index.max_sequence(&creator), Some(3));

        index.index_event(&creator, 7, 2, test_event_id(3));
    ...
    fn test_stats() {
        ...
        index.index_event(&creator_a, 0, 0, test_event_id(1));
        index.index_event(&creator_a, 1, 1, test_event_id(2));
        index.index_event(&creator_b, 0, 2, test_event_id(3));
    ...
    fn test_resolve_slot() {
        ...
        index.index_event(&creator, 5, 42, test_event_id(1));
    ...
    fn test_high_sequence_numbers() {
        ...
        index.index_event(&creator, 1000, 0, test_event_id(1));
